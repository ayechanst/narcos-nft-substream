    ...
    pub mod functions {
        ...
        impl DelBot {
            const METHOD_ID: [u8; 4] = [39u8, 49u8, 35u8, 183u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[ethabi::Token::Address(ethabi::Address::from_slice(&self.notbot))],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
        ...
        impl substreams_ethereum::Function for DelBot {
            const NAME: &'static str = "delBot";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Manualsend {
            const METHOD_ID: [u8; 4] = [111u8, 195u8, 234u8, 236u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Manualsend {
            const NAME: &'static str = "manualsend";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Manualswap {
            const METHOD_ID: [u8; 4] = [195u8, 200u8, 205u8, 128u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Manualswap {
            const NAME: &'static str = "manualswap";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl OpenTrading {
            const METHOD_ID: [u8; 4] = [201u8, 86u8, 123u8, 249u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for OpenTrading {
            const NAME: &'static str = "openTrading";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SetBots {
            const METHOD_ID: [u8; 4] = [181u8, 21u8, 86u8, 106u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetBots {
            const NAME: &'static str = "setBots";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetCooldownEnabled {
            pub onoff: bool,
        }
        impl SetCooldownEnabled {
            const METHOD_ID: [u8; 4] = [89u8, 50u8, 234u8, 209u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(&[ethabi::Token::Bool(self.onoff.clone())]);
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
                encoded
        ...
        impl substreams_ethereum::Function for SetCooldownEnabled {
            const NAME: &'static str = "setCooldownEnabled";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        pub struct MaxTxAmountUpdated {
            pub u_max_tx_amount: substreams::scalar::BigInt,
        }
        impl MaxTxAmountUpdated {
            const TOPIC_ID: [u8; 32] = [
                148u8,
                127u8,
                52u8,
        ...
        impl substreams_ethereum::Event for MaxTxAmountUpdated {
            const NAME: &'static str = "MaxTxAmountUpdated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
