...
start:
  ...
  br i1 %0, label %panic.i, label %"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17h8d48d390a604abfdE.exit"

panic.i:                                          ; preds = %start
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17hd907d42d09324a32E(ptr align 1 @str.0, i64 25, ptr align 8 @alloc_b9f8168abcdc9af15fab5bde6efcdc9e) #3
  unreachable

"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17h8d48d390a604abfdE.exit": ; preds = %start
  ret void
}
...
declare void @_ZN4core9panicking5panic17hd907d42d09324a32E(ptr align 1, i64, ptr align 8) unnamed_addr #2
